...
import (
	...
	"github.com/codeid/part08/pkg/employee"
	"github.com/codeid/part08/pkg/services"
)
...
func main() {
	...
	emp2 := employee.NewProgrammer("Rini", "Maharani", time.Date(2025, time.September, 21, 0, 0, 0, 0, time.UTC), 500_000, deptFinance, employee.INTERNAL)
	emp3 := employee.NewProgrammer("Budi", "Juna", time.Date(2025, time.September, 21, 0, 0, 0, 0, time.UTC), 250_000, deptIt, employee.INTERNAL)
	emp4 := employee.NewProgrammer("Charlie", "Chaplin", time.Date(2025, time.September, 21, 0, 0, 0, 0, time.UTC), 450_000, deptFinance, employee.INTERNAL)
	...
	//3. poopulate with interface,setiap struct yg sudah implement methods interface Info, itu bisa dipoupluate di slice info interface
